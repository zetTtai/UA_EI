...
class Tokenizador {
    ...
    private:
        ...
        bool TokenizarURL(const string& str, const string& delimiters, string::size_type&, string::size_type&,list<string>& tokens, string& tok, const bool& fichero) const;
        ...
        bool TokenizarNumero(const string& str, const string& delimiters, string::size_type&, string::size_type&,list<string>& tokens, string& tok, const bool& fichero) const;
        ...
        bool TokenizarEmail(const string& str, const string& delimiters, string::size_type&, string::size_type&,list<string>& tokens, string& tok, const bool& fichero) const;
        ...
        bool TokenizarAcronimo(const string& str, const string& delimiters, string::size_type&, string::size_type&, list<string>& tokens, string& tok, const bool& fichero) const;

        //Heurística aplicada a Tokenizar una multipalabra
        bool TokenizarMultipalabra(const string& str, const string& delimiters, string::size_type&, string::size_type&, list<string>& tokens, string& tok, const bool& fichero) const;

    public:
        //Transforma las mayúsculas a minúsculas y quita los acentos
        void Filtrar(string&) const;
        void Filtrar(char *) const;
        ...
        void Tokenizar (const string& str, string& tokens) const;
