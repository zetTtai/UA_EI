...
class IndexadorHash {
    ...
    private:
        ...
        unordered_map<string,vector<int>> ExtractInfo(string&, InfDoc&) const;
        ...
        bool AddTerms(const string&, const unordered_map<string, vector<int>>&, InfDoc&);
    ...
    public:
        ...
        //-------------------------------------------------------------------------------------------------------------------------------------------------
        // Nuevos métodos para buscador
        //-------------------------------------------------------------------------------------------------------------------------------------------------
        unordered_map<string, InformacionTermino> DevolverIndice() const {return this->indice;}

        unordered_map<string, InfDoc> DevolverDocsIndexados() const{return this->indiceDocs;}

        unordered_map<string, InformacionTerminoPregunta> DevolverIndicePregunta() const {return this->indicePregunta;}

        bool DevuelveInfDoc(const long int& id, InfDoc& inf) const
        {
        ...
        InfColeccionDocs DevuelveInfColeccion() const {return this->informacionColeccionDocs;}

        // // Devuelve true si el documento contiene algún termino de la pregunta indexada y guarda la información en infDoc
